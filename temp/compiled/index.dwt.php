        ...
        <header class="index-header"> 
            ...
            <div class="index-search-box">
                <form id="searchForm" name="searchForm" method="get" action="search.php" onSubmit="return checkSearchForm()">
                    <input name="keywords" id="keyword" type="text" class="index-search-input" placeholder="好站长资源" onclick="openSearch();">
   ...
   document.getElementById("leftTime"+key).innerHTML =a + b + c + d; //显示倒计时信息
    ...
    <div class="swiper-container" style="margin-top:56px;">
        <div class="swiper-wrapper">
		    <?php $_from = $this->_var['banner']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'banner_0_91086200_1482286663');if (count($_from)):
    foreach ($_from AS $this->_var['banner_0_91086200_1482286663']):
?>
            <div class="swiper-slide"><a href="<?php echo $this->_var['banner_0_91086200_1482286663']['ad_link']; ?>"><img src="<?php echo $this->_var['banner_0_91086200_1482286663']['ad_code']; ?>" width="100%"/></a></div>
...
?>
	...
	<div class="blank"></div>
    <div class="ads5">
	    <?php $_from = get_advlist_position_name(首页5图_1元夺宝,1); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad');if (count($_from)):
    foreach ($_from AS $this->_var['ad']):
?>
		<li><a href="<?php echo $this->_var['ad']['url']; ?>"><img src="<?php echo $this->_var['ad']['image']; ?>"></a></li>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		<?php $_from = get_advlist_position_name(首页5图_4小图,4); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad');if (count($_from)):
    foreach ($_from AS $this->_var['ad']):
?>
		<li><a href="<?php echo $this->_var['ad']['url']; ?>"><img src="<?php echo $this->_var['ad']['image']; ?>"></a></li>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
